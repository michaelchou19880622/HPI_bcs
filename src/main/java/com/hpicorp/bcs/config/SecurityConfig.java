...
import com.hpicorp.bcs.security.CustomUserDetailsService;
import com.hpicorp.bcs.security.JwtAuthenticationEntryPoint;
import com.hpicorp.bcs.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
            ...
            .antMatchers(HttpMethod.GET, "/getMessageTemplate/*").permitAll() // 取得 MessageTemplate 的圖片
